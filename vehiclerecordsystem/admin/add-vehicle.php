...
$owner_name = $_POST['owner_name']; // Add this line
...
if($query -> rowCount() == 0)
{
$sql="INSERT INTO tblvehicle(BrandID,VehicleName,ModelNum,RegNum,VehicleType,VehcleSubtype,Varient,Transmission,ChasisNumber,EngineNumber,Description,owner_name) Values(:brandid,:vehiclename,:modelnumber,:regnumber,:vehicletype,:vehiclesubtype,:varient,:transmission,:chasisnum,:enginenumber,:description,:owner_name)";
...
$query->bindParam(':owner_name',$owner_name,PDO::PARAM_STR); // Add this line
$query -> execute();
...
{               ?>
                ...
                <div class="form-group col-md-12">
                  ...
                  <input class="form-control" name="owner_name" id="owner_name" type="text" placeholder="Enter Owner Name" required="true">
                </div>
